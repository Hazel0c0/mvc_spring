...
public class ScoreRepositoryImpl implements ScoreRepository {
    ...
    static {
        ...
        Score stu1 = new Score(new ScoreRequestDTO("뽀로로", 100, 34, 91,++sequence));
        Score stu2 = new Score(new ScoreRequestDTO("춘식이", 77, 99, 87,++sequence));
        Score stu3 = new Score(new ScoreRequestDTO("대길이", 98, 66, 85,++sequence));
        Score stu4 = new Score(new ScoreRequestDTO("대길삼", 68, 56, 95,++sequence));
        Score stu5 = new Score(new ScoreRequestDTO("대길사", 90, 99, 89,++sequence));

        scoreMap.put(stu1.getStuNum(), stu1);
        scoreMap.put(stu2.getStuNum(), stu2);
        scoreMap.put(stu3.getStuNum(), stu3);
        scoreMap.put(stu4.getStuNum(), stu4);
        scoreMap.put(stu5.getStuNum(), stu5);
    }
